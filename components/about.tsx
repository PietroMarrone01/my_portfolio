...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        I am Pietro Marrone, and I was born in Bari, Italy. I pursued my Master's in{" "}
      ...
      <p>
        <span className="italic">When I'm not working</span>, I enjoy doing any kind of sport, 
